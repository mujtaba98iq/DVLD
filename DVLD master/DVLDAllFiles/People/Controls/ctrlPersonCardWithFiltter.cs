...
namespace DVLD2.People.Controls
{
    public partial class ctrlPersonCardWithFiltter : UserControl
    {
        ...
        public int PersonID
        {
            get { return ctrlPersonCard21.PersonID; }
        }

        public clsPeople SelectedPersonInfo
        {
            get { return ctrlPersonCard21.SelectedPersonInfo; }
        }
        ...
        private void FindNow()
        {
         switch(cbFilterBy.Text)
            {
                case "Person ID":
                    ctrlPersonCard21.LoadPersonInfo(int.Parse(txtFilterValue.Text));
                    break;
                case "National No.":
                    ctrlPersonCard21.LoadPersonInfo(txtFilterValue.Text);
                    break;
            ...
            if (OnPersonSelected != null)
                OnPersonSelected(ctrlPersonCard21.PersonID);
        }
